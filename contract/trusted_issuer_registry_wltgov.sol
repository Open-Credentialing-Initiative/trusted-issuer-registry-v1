...
contract TrustedIssuerList {
    ...
    function addStatekeeper(address _statekeeperAddress) public onlyStatekeepers {
    ...
    function removeStatekeeper(address _statekeeperAddress) public onlyStatekeepers {
        if (statekeepers.map[_statekeeperAddress]) {
